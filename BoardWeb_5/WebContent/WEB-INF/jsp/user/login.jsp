...
input{width:200px;height: 25px ;border:none;margin-top:15px ;margin-left: 57px; margin-bottom:15px} 
...
a{text-decoration: none;display:inline-block; margin: 0px 0px 20px 169px; color:#F2EBF5}
